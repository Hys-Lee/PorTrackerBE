...
*Note: Use `gradlew.bat` instead of `./gradlew` on Windows if not using a POSIX-compliant shell.*
...
*This file is generated for agentic use. Maintain these standards to ensure codebase consistency.*
