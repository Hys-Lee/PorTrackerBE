...
public class AssetRepository {
    ...
    private static String CORE_SELECT_SQL =
            String.format(
                    "SELECT a.%s, a.%s, a.%s, a.%s, a.%s, a.%s, a.%s, a.%s, a.%s",
                    SqliteSchema.COL_ID,
    ...
    public Optional<AssetRecord> findByPublicId(JdbcTemplate jdbcTemplate, String publicId) {
        ...
        return jdbcTemplate.query(sql, ps -> ps.setString(1, publicId), assetMapper).stream()
                .findFirst();
    }

    private final RowMapper<AssetRecord> assetMapper =
            (rs, rowNum) ->
                    AssetRecord.builder()
                            ...
                            .currencyPublicId(rs.getString(sqlCurrencyPublicIdName))
                            .build();
    ...
    public List<AssetRecord> findByPublicIds(
