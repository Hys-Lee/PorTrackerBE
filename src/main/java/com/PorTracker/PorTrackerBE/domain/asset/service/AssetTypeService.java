...
public class AssetTypeService {
        ...
        public void updateAssetType(String userId, String publicId, AssetTypeRequest request) {
                ...
                String sql = String.format(
                                ...
                                SqliteSchema.TABLE_ASSET_TYPE, SqliteSchema.COL_NAME,
                ...
                log.info("asset type updated successfully for user: {}, publicId: {}", userId,
                                publicId);
        }
        ...
        public void deleteAssetType(String userId, String publicId) {
                ...
                String sql = String.format(
                                ...
                                SqliteSchema.TABLE_ASSET_TYPE, SqliteSchema.COL_DELETED_AT,
                ...
                log.info("asset type deleted successfully for user: {}, publicId: {}", userId,
                                publicId);
        }
}
